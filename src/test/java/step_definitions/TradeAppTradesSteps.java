...
public class TradeAppTradesSteps {
	...
	// UI data validation against database #Start
	...
	public void the_trade_data_resides_in_data_base_correctly() {
		...
		String selectQuery = "SELECT long_short, symbol, entry_price, exit_price FROM records WHERE symbol = " +"'" + stockSymbol + "'";
...
// Insert DB scenario #Starts
	...
	public void i_executed_insert_query_with_the_following_data_to_database(DataTable dataTable) {
		...
		String insertQuery ="INSERT INTO records VALUE("+id+","+user_id+","+long_short+","+symbol+","+entryPrice+","+closeDate+","+exitPrice+","+gain+")";
