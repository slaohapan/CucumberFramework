...
public class SauceDemoLoginSteps {
	...
	@When("I enter a valid username {string} password {string}")
	public void i_enter_a_valid_username_password(String username, String password) {
	...
	@When("I enter a invalid username {string} password {string}")
	public void i_enter_a_invalid_username_password(String username, String invalidpassword) {
		page.username.sendKeys(username);
